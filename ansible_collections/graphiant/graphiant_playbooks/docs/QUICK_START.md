...
antsibull-docs sphinx-init --use-current --dest-dir docs --squash-hierarchy graphiant.graphiant_playbooks
...
```bash
cd ansible_collections/graphiant/graphiant_playbooks/docs
./build.sh
```
...
- **Solution**: Install the collection first: `ansible-galaxy collection install ansible_collections/graphiant/graphiant_playbooks/ --force`
