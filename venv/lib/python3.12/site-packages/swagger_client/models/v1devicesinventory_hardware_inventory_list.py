...
class V1devicesinventoryHardwareInventoryList(object):
    ...
    def __init__(self, assigned_on=None, created_on=None, device_model=None, device_serial=None, ek_cert=None, enterprise_id=None, enterprise_name=None, gek_pub=None, is_core=None, is_new=None, is_requested=None, parent_enterprise_id=None, parent_enterprise_name=None, use_oauth=None, uuid=None):  # noqa: E501
